        ...
        .scat = function(image, ggtheme, theme, ...) {
            ...
            base::suppressMessages({
                base::suppressWarnings({
                    ...
                    p <- 
                        ggplot2::ggplot(
                            data, ggplot2::aes(x=x, y=y, color=g, fill=g)
                        ) + 
                    ...
                    if (marg == "dens") {
                        xdens <- 
                            cowplot::axis_canvas(p, axis="x") +
                            ggridges::geom_ridgeline(
                                data=data, 
                                ggplot2::aes(x, y=0, height=..density.., fill=g), 
                                stat="density", 
                                alpha=0.5, 
                                size=.2, 
                                trim=FALSE
                        ...
                        ydens <- 
                            cowplot::axis_canvas(p, axis="y") +
                            ggridges::geom_vridgeline(
                                data=data, 
                                ggplot2::aes(x=0, y=y, width=..density.., fill=g), 
                                stat="ydensity", 
                                alpha=0.5, 
                                size=.2, 
                                trim=FALSE
